...
{
    public partial class TomTheTuoi : Form
    {
        ...
        private void pBoxAddToCart_Click(object sender, EventArgs e)
        {
            ...
            cm.Parameters.AddWithValue("@ProductId", "F001");
            cm.Parameters.AddWithValue("@ProductName", "Tôm thẻ tươi");
            cm.Parameters.AddWithValue("@Price", "120000"); ;
