...
{
    public partial class SalamiTieuDo : Form
    {
        ...
        private void pBoxAddToCart_Click(object sender, EventArgs e)
        {
            ...
            cm.Parameters.AddWithValue("@ProductId", "F004");
            cm.Parameters.AddWithValue("@ProductName", "Salami tiêu đỏ");
            cm.Parameters.AddWithValue("@Price", "108000"); ;
