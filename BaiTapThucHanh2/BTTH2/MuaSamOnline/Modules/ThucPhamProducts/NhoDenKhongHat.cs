...
{
    public partial class NhoDenKhongHat : Form
    {
        SqlConnection cn = new SqlConnection();
        SqlCommand cm = new SqlCommand();
        DBConnect dbcon = new DBConnect();

        public NhoDenKhongHat()
        {
            InitializeComponent();
        ...
        private void pBoxAddToCart_Click(object sender, EventArgs e)
        {
            ...
            cm.Parameters.AddWithValue("@ProductId", "F005");
            cm.Parameters.AddWithValue("@ProductName", "Nho đen không hạt");
            cm.Parameters.AddWithValue("@Price", "105000"); ;
