...
{
    public partial class QuanTayNam : Form
    {
        ...
        private void pBoxAddToCart_Click(object sender, EventArgs e)
        {
            ...
            cm.Parameters.AddWithValue("@ProductId", "W002");
            cm.Parameters.AddWithValue("@ProductName", "Quần tây âu nam");
            cm.Parameters.AddWithValue("@Price", "99000"); ;
