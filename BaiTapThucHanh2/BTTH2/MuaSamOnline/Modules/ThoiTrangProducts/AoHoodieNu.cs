...
{
    public partial class AoHoodieNu : Form
    {
        ...
        private void pBoxAddToCart_Click(object sender, EventArgs e)
        {
            ...
            cm.Parameters.AddWithValue("@ProductId", "W004");
            cm.Parameters.AddWithValue("@ProductName", "Áo hoodie nữ");
            cm.Parameters.AddWithValue("@Price", "125000"); ;
