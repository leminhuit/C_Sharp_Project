...
{
    public partial class AoThoiTrang : Form
    {
        ...
        private void pBoxAddToCart_Click(object sender, EventArgs e)
        {
            ...
            cm.Parameters.AddWithValue("@ProductId", "W006");
            cm.Parameters.AddWithValue("@ProductName", "Áo thời trang Eden Caro");
            cm.Parameters.AddWithValue("@Price", "149000"); ;
