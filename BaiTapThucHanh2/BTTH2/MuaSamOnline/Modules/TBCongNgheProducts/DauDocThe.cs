...
{
    public partial class DauDocThe : Form
    {
        ...
        private void pBoxAddToCart_Click(object sender, EventArgs e)
        {
            ...
            cm.Parameters.AddWithValue("@ProductId", "E004");
            cm.Parameters.AddWithValue("@ProductName", "Đầu đọc thẻ nhớ đa năng");
            cm.Parameters.AddWithValue("@Price", "296000"); ;
