...
{
    public partial class GiayInMaVach : Form
    {
        ...
        private void pBoxAddToCart_Click(object sender, EventArgs e)
        {
            ...
            cm.Parameters.AddWithValue("@ProductId", "L005");
            cm.Parameters.AddWithValue("@ProductName", "Giấy in mã vạch");
            cm.Parameters.AddWithValue("@Price", "45000"); ;
