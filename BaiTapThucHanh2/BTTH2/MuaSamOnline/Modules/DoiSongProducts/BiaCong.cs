...
{
    public partial class BiaCong : Form
    {
        ...
        private void pBoxAddToCart_Click(object sender, EventArgs e)
        {
            ...
            cm.Parameters.AddWithValue("@ProductId", "L006");
            cm.Parameters.AddWithValue("@ProductName", "Bìa còng FlexOffice");
            cm.Parameters.AddWithValue("@Price", "39000"); ;
