...
{
    public partial class VotCauLong : Form
    {
        ...
        private void pBoxAddToCart_Click(object sender, EventArgs e)
        {
            ...
            cm.Parameters.AddWithValue("@ProductId", "S006");
            cm.Parameters.AddWithValue("@ProductName", "Vợt cầu lông Guangyu");
            cm.Parameters.AddWithValue("@Price", "419000"); ;
