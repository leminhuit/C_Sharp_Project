...
{
    public partial class LeuCamTrai : Form
    {
        ...
        private void pBoxAddToCart_Click(object sender, EventArgs e)
        {
            ...
            cm.Parameters.AddWithValue("@ProductId", "S001");
            cm.Parameters.AddWithValue("@ProductName", "Lều cắm trại");
            cm.Parameters.AddWithValue("@Price", "560000"); ;
