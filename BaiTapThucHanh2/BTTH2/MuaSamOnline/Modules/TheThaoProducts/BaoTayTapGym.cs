...
{
    public partial class BaoTayTapGym : Form
    {
        ...
        private void pBoxAddToCart_Click(object sender, EventArgs e)
        {
            ...
            cm.Parameters.AddWithValue("@ProductId", "S004");
            cm.Parameters.AddWithValue("@ProductName", "Bao tay tập gym");
            cm.Parameters.AddWithValue("@Price", "85000"); ;
