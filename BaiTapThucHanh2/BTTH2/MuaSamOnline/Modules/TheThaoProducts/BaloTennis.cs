...
{
    public partial class BaloTennis : Form
    {
        ...
        private void pBoxAddToCart_Click(object sender, EventArgs e)
        {
            ...
            cm.Parameters.AddWithValue("@ProductId", "S003");
            cm.Parameters.AddWithValue("@ProductName", "Balo Tennis");
            cm.Parameters.AddWithValue("@Price", "1499000"); ;
