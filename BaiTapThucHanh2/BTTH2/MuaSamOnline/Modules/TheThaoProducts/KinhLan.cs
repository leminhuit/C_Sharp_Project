...
{
    public partial class KinhLan : Form
    {
        ...
        private void pBoxAddToCart_Click(object sender, EventArgs e)
        {
            ...
            cm.Parameters.AddWithValue("@ProductId", "S005");
            cm.Parameters.AddWithValue("@ProductName", "Kính lặn kèm ống thở");
            cm.Parameters.AddWithValue("@Price", "199000"); ;
