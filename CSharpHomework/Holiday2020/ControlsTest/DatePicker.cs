...
namespace Holiday2020.ControlsTest
{
    public class DatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Properties.Resources.FilledStar;
        ...
        public Color SkinColor
        {
            get => skinColor; set
            {
                skinColor = value; if (skinColor.GetBrightness() >= 0.8F)
                    calendarIcon = Properties.Resources.EmptyStar;
                else calendarIcon = Properties.Resources.FilledStar; this.Invalidate();
            }
        }
